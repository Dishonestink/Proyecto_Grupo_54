    ...
    <div id="divPrincipal">
        ...
        <div id="divCentral" class="Division">
            ...
            <header id="headerDer"> <!--Se añade otra etiqueta semántica de HEADER-->
                <span><h1 id="HeaderSentence"><b>Modificación de horarios y salones de clase</b></h1></span>
            ...
            <div class="ContenedorTabla"> <!--Seccion que contiene la tabla y la barra de desplazamiento-->
                <table> <!--Información de Tabla-->
                    ...
                    <tr v-for="(item,index) in items" :key="item.id" contenteditable="true">
                        ...
                        <td v-text="item.profesor"></td>
                        <td v-text="item.contenido"></td>
                        <td v-text="item.asistencia"></td>
                        <td id="celdaEliminar"><input type="button" id="btnEliminar" value="&#128465;" v-on:click="eliminar(index)"></td>
                    </tr>
